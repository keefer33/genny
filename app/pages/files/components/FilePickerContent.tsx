...
export function FilePickerContent({
  ...
  useEffect(() => {
    if (userId) {
      loadUserFiles(currentPage, userId, [], null, effectiveFileType, false, genModelId ?? null);
    }
  }, [userId, currentPage, effectiveFileType, genModelId, loadUserFiles]);

  useEffect(() => {
    setCurrentPage(1);
  }, [effectiveFileType, genModelId]);
